...
import { MbscOptionsService, localeEn, localeBg, localeAr, localeCa, localeCs, localeHr, localeZh, localeDa, localeDe, localeEs, localeFr, localeEl, localeFi, localeHi, localeKo, localeIt, localeJa, localeLt, localeHu, localeNl, localeNo, localePl, localePtPT, localeRo, localeSk, localeSr, localeSv, localeTr, localeVi, localeRu, localeFa, localeHe, MbscOptions } from '@mobiscroll/angular';
